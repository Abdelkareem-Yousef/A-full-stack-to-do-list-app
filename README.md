...
```bash
git clone https://github.com/Abdelkareem-Yousef/A-full-stack-to-do-list-app.git
cd A-full-stack-to-do-list-app
```
...
Built by **Abdelkareem Yousef**  
GitHub: [@Abdelkareem-Yousef](https://github.com/Abdelkareem-Yousef)
